  ...
  return (
    <>
      ...
      >
        ...
        <Stack.Screen name="event/new" options={{ presentation: 'modal', gestureEnabled: false }} />
        <Stack.Screen name="event/category-picker" />
        <Stack.Screen name="event/[id]/index" />
        <Stack.Screen name="event/[id]/edit" options={{ presentation: 'modal', gestureEnabled: false }} />
